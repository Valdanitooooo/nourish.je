...
OSVR Cardboard is currently in the App Store review process.
</div>
...
SteamVR support in OSVR Cardboard is experimental. SteamVR must be used in Extended mode. Start SteamVR, run your game, then find the Steam window named "Headset Window" and click inside it. This should make it fullscreen, and it will appear on the phone.
